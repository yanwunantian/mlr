...
#'   Is applied in every resampling iteration to every \code{\link{WrappedModel}} resulting from calls to \code{\link{train}} during resampling.
...
#'   }
#'   And the result will be a named list.